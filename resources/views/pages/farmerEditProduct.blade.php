    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{ route('farmer.update_product_request') }}" enctype="multipart/form-data">

              {{ csrf_field() }}

              <input type="hidden" name="updataProductId" value="{{ $id }}">
              ...
              <div class="form-group{{ $errors->has('product_catagory') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <select  id="product_catagory" required="required" class="form-control col-md-7 col-xs-12" name="product_catagory" value="{{ $product_data->product_catagory }}">
              ...
              <div class="form-group{{ $errors->has('product_name') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="product_name" name="product_name" required="required" class="form-control col-md-7 col-xs-12" list="suggestions"  value="{{ $product_data->product_name }}">
              ...
              <div class="form-group{{ $errors->has('unit') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <select id="unit" name="unit" class="form-control col-md-7 col-xs-12  value="{{ $product_data->unit }}">
              ...
              <div class="form-group{{ $errors->has('product_quantity') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="product_quantity" class="form-control col-md-7 col-xs-12" type="text" name="product_quantity"  value="{{ $product_data->product_quantity }}">
              ...
              <div class="form-group{{ $errors->has('product_price') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="product_price" class="form-control col-md-7 col-xs-12" type="text" name="product_price"  value="{{ $product_data->product_price }}">
              ...
              <div class="form-group{{ $errors->has('product_image') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="product_image" class="form-control col-md-7 col-xs-12" type="file" name="product_image"  value="{{ $product_data->product_image }}">
              ...
              <div class="form-group{{ $errors->has('product_available_from') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="product_available_from" class="form-control col-md-7 col-xs-12" type="date" name="product_available_from"  value="{{ $product_data->product_available_from }}">
              ...
              <div class="form-group{{ $errors->has('product_available_to') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="product_available_to" class="form-control col-md-7 col-xs-12" type="date" name="product_available_to"  value="{{ $product_data->product_available_to }}">
